(function(){
  ...
  function bootApp(){
    loadScript('./app-v29.js', function(){
      loadScript('./app-v31-polish.js', function(){
        loadScript('./app-v32-polish.js', function(){
          loadScript('./app-v33-polish.js');
        });
      });
    });
  }
  fetch('./alarms.json?source=v34-' + Date.now(), { cache: 'no-store' })
