...
@Test func alarmKitOwnsDepartureAndStopHandsOffToCommander() throws {
  ...
  #expect(live.contains("label: display.nextEventLabel"))
  #expect(live.contains("nextEventLabel: \"Další:\""))
  #expect(live.contains("nextEventLabel: followingIsActive ? \"Současně:\" : \"Další:\""))
...
@Test func commanderContextHasNoPostStopGapAndStaleFallsForwardToNextEvent() throws {
  ...
  #expect(live.contains("followingIsActive ? \"Současně:\" : \"Další:\""))
